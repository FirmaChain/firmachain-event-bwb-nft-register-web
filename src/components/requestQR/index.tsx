...
const RequestQR = ({
  ...
  const generateRequest = async () => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_API_HOST}/gallery/sign/${requestType}`, {
        signer,
      });
  ...
  const getRequestStatus = async (requestKey: string) => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_HOST}/gallery/requests/${requestKey}`);
